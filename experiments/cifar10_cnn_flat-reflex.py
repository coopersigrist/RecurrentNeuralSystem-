...
from models.models import FlattenedConvolutionalEncoder, FlattenedConvolutionalDecoder, FlattenedEncoderClassifier, ModulatedFlattenedConvolutionalEncoder
import math
...
encoder1 = FlattenedConvolutionalEncoder(reflexor_size).to(device)
decoder1 = FlattenedConvolutionalDecoder(reflexor_size).to(device)
classifier1 = FlattenedEncoderClassifier(reflexor_size, 10).to(device)
auto_params1 = list(encoder1.parameters()) + list(decoder1.parameters())

encoder2 = ModulatedFlattenedConvolutionalEncoder(reflexor_size).to(device)
decoder2 = FlattenedConvolutionalDecoder(reflexor_size).to(device)
classifier2 = FlattenedEncoderClassifier(reflexor_size, 10).to(device)
